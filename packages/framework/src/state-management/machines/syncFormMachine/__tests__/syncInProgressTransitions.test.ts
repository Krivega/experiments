...
describe('syncActor: transitions from SYNC_IN_PROGRESS', () => {
  ...
  it('should initially be SYNC_IN_PROGRESS', () => {
    expect(syncActor.getSnapshot().value).toBe(SYNC_IN_PROGRESS);
  });

  it('should not transition to NOT_SAVED before EVENT_SYNC_SUCCESS', () => {
  ...
  it('should not transition to SAVE_IN_PROGRESS before EVENT_SYNC_SUCCESS', () => {
  ...
  it('should not transition to SYNCED before EVENT_SYNC_SUCCESS', () => {
  ...
  it('should not transition to SAVE_ERROR before EVENT_SYNC_SUCCESS', () => {
